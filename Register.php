        ...
        <main role="main">
            ...
            <header class="section background-dark">
                <div class="line">
                    ...
                    <h1 class="text-white margin-top-bottom-0 text-size-60 text-line-height-1"
                        style="text-align:center"><br><br> Registration Form</h1>
                    ...
                    <form action='RegisterForm.php' method="POST">
                        ...
                        <table style="margin-top:50px;color:black;border-radius:5px;">
                            ...
                            <tr>
                                <td style="padding:20px;text-align:center;" colspan=4><input type=submit name=register
                                        value='Click to Register' /></td>
                            </tr>
