      ...
      <article>
        <header class="section background-dark">
          <div class="line">
            ...
            <p class="margin-bottom-0 text-size-16">For IRCTC SBI Card users who do not receive the card within 01 month from the date of application kindly call on the Railway SBI Card Helpline nos. at 0124-39021212 or 18001801295 (if calling from BSNL/MTNL line) or send email to feedback.gesbi@ge.com. For other queries on your IRCTC SBI card account, kindly email at loyaltyprogram@irctc.co.in
</p>
          </div>
        </header>
            ...
            <div class="margin">
              <div class="s-12 m-12 l-4 margin-m-bottom">
                ...
                <div class="margin-left-70 margin-s-left-0 margin-bottom">
                  ...
                  <p>Federation of Railway Officer's Association Office, 256-A, Rail Bhavan, Raisina Road, New Delhi -110001 <br>
                  </p>
                </div>
                </div>
              </div>
